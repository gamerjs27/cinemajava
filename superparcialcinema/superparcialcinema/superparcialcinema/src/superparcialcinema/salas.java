...
class salas {
    ...
    boolean i=false;
    String[][][] graficar() throws IOException {
        System.err.println("graficar" + " inicio correctamente");
        actualizardatos();
        return salas;
    }

    boolean verificarnuevareserva(int sala, int puesto, int largo) throws IOException {
        System.err.println("verificarnuevareserva" + " inicio correctamente");
        actualizardatos();
        return "l".equals(salas[sala][puesto][largo]);
    }

    void nuevasreservas(int salat, int puestot, int largot) throws IOException {
    ...
    void eliminarreserva() throws IOException {
    ...
    void cambiarsalaapagada(int salat, int puestot, int largot) throws IOException {
    ...
    boolean estareservada(int sala, int puesto, int largo) throws IOException {
